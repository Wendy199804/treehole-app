		...
		<view class="verifyBox">
			...
			<view class="slide-content">
				...
				<view class="slider-pintu">
					<image id="pintuImg" :src="'../../static/' + img + '.jpg'" class="pintu img"></image>

					<view class="pintukuai" :style="{ top: top + 'px', left: oldx + 'px' }">
						<image class="img" :src="'../../static/' + img + '.jpg'" :style="{ top: '-' + top + 'px', left: '-' + left + 'px'}"></image>
					</view>
				...
				<view class="slider-movearea" @touchend="endTouchMove">
					<movable-area :animation="true" class="movable-area">
						<movable-view class="movable-view" :x="x" direction="horizontal" @change="startMove"></movable-view>
					</movable-area>
	...
	.slider-movearea {
		...
		.movable-area {
			...
			.movable-view {
				...
				background-image: url(../static/icon-button-normal.png);
